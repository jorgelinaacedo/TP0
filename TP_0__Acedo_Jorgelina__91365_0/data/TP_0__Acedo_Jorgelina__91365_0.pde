...
strokeWeight (5);
fill(60,60,60);
text ("THE NIGHTMARE", 132,21);
text ("BEFORE A CHRISTMAS", 122,32);
*/
...
triangle (172,204,181,195,167,215);
...
triangle (88,260,92,261,96,254);
triangle (95,269,98,274,105,262);
triangle (105,278,109,283,114,268);
triangle (115,288,119,290,122,275);
triangle (126,293,132,297,133,280);
triangle (139,301,146,303,144,285);
triangle (153,304,162,306,155,287);
triangle (169,306,177,308,170,290);
triangle (184,308,193,309,185,290);
triangle (201,306,207,306,200,290);
triangle (216,307,223,307,214,290);
triangle (231,307,240,306,230,289);
triangle (248,303,255,300,243,286);
triangle (264,296,270,290,256,280);
triangle (279,284,287,279,270,272);
triangle (293,272,298,266,283,259);
triangle (302,261,304,257,294,252);

//dientitos abajo 
triangle (88,260,92,264,77,267);
triangle (95,269,98,274,81,276);
triangle (105,278,109,283,88,285);
triangle (115,288,118,290,88,294);
triangle (126,293,132,297,108,303);
triangle (139,301,146,303,125,311);
triangle (153,304,162,306,142,317);
triangle (169,306,177,308,160,320);
triangle (184,308,193,309,180,322);
triangle (201,306,207,306,196,323);
triangle (216,307,223,307,213,328);
triangle (216,307,223,307,238,324);
triangle (231,307,240,306,265,321);
triangle (264,296,270,290,281,310);
triangle (279,284,287,279,298,293);
triangle (293,272,298,266,309,280);
triangle (302,261,304,257,316,271);
